...
<div class="card mb-4">
  <h5 class="card-header">اضافة شركاء</h5>
  <form class="card-body" action="/save_user" method="POST">
    ...
    <div class="row g-3">
        <div class="col-md-6">
          <label class="form-label" for="multicol-username"> تاريخ الشراكة </label>
          <input name="name" type="date"  id="multicol-username" class="form-control" placeholder="....." >
        </div>
      </div>
      <div class="row g-3">
        <div class="col-md-6">
          <label class="form-label" for="multicol-username"> صورة الشركة </label>
          <input name="name" type="file"  id="multicol-username" class="form-control"  >
        </div>
      </div>
      <div class="col-md-6">
