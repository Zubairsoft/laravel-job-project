...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_user" method="POST">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الموقع </label>
      ...
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-password">الصندوق</label>
          <div class="input-group input-group-merge">
      ...
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-password">الفاكس</label>
          <div class="input-group input-group-merge">
            <input  name="password" type="text" id="multicol-password" class="form-control">
          </div>
        </div>
      ...
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-password">الايميل</label>
          <div class="input-group input-group-merge">
            <input  name="password" type="text" id="multicol-password" class="form-control">
          </div>
        </div>
