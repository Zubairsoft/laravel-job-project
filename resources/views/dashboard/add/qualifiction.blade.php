...
<div class="card mb-4">
  <h5 class="card-header">  المؤهلات العلمية </h5>
  <form class="card-body" action="/save_user" method="POST">

    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">المؤهل   </label>
      ...
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-password">تاريخ اخد الشهادة</label>
          <div class="input-group input-group-merge">
