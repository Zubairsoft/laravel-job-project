...
<div class="card mb-4">
  <h5 class="card-header"> اضافة مهارات  </h5>
  <form class="card-body" action="/save_user" method="POST">
    ...
    <div class="row g-3">
        <div class="col-md-6">
          <label class="form-label" for="multicol-username">درجة الاتقان</label>
          <input name="name" type="number"  id="multicol-username" class="form-control" placeholder="....." >
        </div>
      </div>
      <div class="col-md-6">
