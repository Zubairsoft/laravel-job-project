...
<div class="card mb-4">
  <h5 class="card-header"> الخبرات  </h5>
  <form class="card-body" action="/save_user" method="POST">

    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">عنوان الخبرة</label>
        <input name="name" type="text"  id="multicol-username" class="form-control" placeholder="....." >
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">تاريخ الخبرة</label>
        <div class="input-group input-group-merge">
          <input type="date"  name="date" class="form-control"  aria-describedby="multicol-email2" >
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-password">وصف الخبرة</label>
          <div class="input-group input-group-merge">
